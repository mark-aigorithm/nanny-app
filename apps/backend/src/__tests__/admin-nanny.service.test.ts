jest.mock('@backend/db/prisma', () => ({
  prisma: {
    nannyProfile: { findFirst: jest.fn(), findUniqueOrThrow: jest.fn() },
...
import { setNannySkills } from '@backend/services/admin-nanny.service';

const mockPrisma = prisma as unknown as {
  nannyProfile: { findFirst: jest.Mock; findUniqueOrThrow: jest.Mock };
